...
if __name__ == '__main__':
    parameters = param_parser.Parameters("D:\minesweeper\config\params.ini")
    ...
    point_list.append((37.7, -360))
    point_list.append((-760, -360))
    point_list.append((-760, -463))
    point_list.append((34.7, -463))
    point_list.append((37.7, -551))
    point_list.append((-760, -551))
